...
public class AddAddressActivity extends BaseActivity {
    ...
    @ViewInject(R.id.activity_add_address)
    LinearLayout parent;
    ...
    public void initView() {
        initTop(R.mipmap.left_white,"新建收货地址",-1);
    ...
    public void initData() {
        super.initData();
        addressOld = (Address) getIntent().getSerializableExtra("address");

        if (addressOld != null) {
            name.setText(addressOld.getReceiveName());
            address.setText(addressOld.getReceiveAddress());
            phone.setText(addressOld.getReceivePhone());
            pca.setText(addressOld.getDistrict());
        }
    }
    ...
    private void initPupupwindow() {
        ...
        window.setAnimationStyle(R.style.pop_ani_style);
...
//        window.showAsDropDown(etAdress);
    ...
    public void btn_sure(View view) {
        ...
        String phoStr = phone.getText().toString();
        String pcaStr = pca.getText().toString();
        ...
        if (phoStr == null||phoStr.length()!=11) {
            UIUtils.showToast("电话不正确");
            return;
        }
        ...
        if (addressOld!=null){
            ...
            if (UserManager.isLogin()) {
                editAddress(nameStr, phoStr, pcaStr,addressStr);
            }
            /*修改情况*/
            ...
            if (UserManager.isLogin()) {
                addAddress(nameStr, phoStr, pcaStr,addressStr);
            }
    ...
    private void editAddress(final String name, final String phone, final String district, final String address) {
        ...
        entity.addBodyParameter("dataId",addressOld.getReceiveId()+"");
        entity.addBodyParameter("flag","0");
        entity.addBodyParameter("arg1",name);
        entity.addBodyParameter("arg2",phone);
        entity.addBodyParameter("arg3",address);
        entity.addBodyParameter("arg4",district);
        x.http().post(entity, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                if (netData.getResult()==200) {
                    ...
                    addressOld.setDistrict(district);
                    addressOld.setReceiveAddress(address);
                    addressOld.setReceiveName(name);
                    addressOld.setReceivePhone(phone);

                    Intent intent = getIntent().putExtra("address", addressOld);
    ...
    private void addAddress(String name,String phone,String district,String address){

        final ProgressDialog dialog=new ProgressDialog(mActivity);
        dialog.setMessage("正在添加...");
        dialog.show();

        RequestParams entity = new RequestParams(UrlUtils.N_addReceiveInfo);
        entity.addBodyParameter("appuserId", UserManager.getUser().getAppuserId()+"");
        entity.addBodyParameter("arg1",name);
        entity.addBodyParameter("arg2",phone);
        entity.addBodyParameter("arg3",address);
        ...
        x.http().post(entity, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                if (netData.getResult()==200) {
                    ...
                    Address address1 = addresses.get(addresses.size() - 1);
                    if (address1 != null) {

                        Intent intent = getIntent().putExtra("address", address1);
