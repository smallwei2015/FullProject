...
import com.vode.living.receiver.Observer;
import com.vode.living.receiver.PhoneCallStateObserver;
import com.vode.living.services.PlayerService;
...
import static com.netease.neliveplayer.playerkit.sdk.constant.CauseCode.CODE_VIDEO_STOPPED_AS_NET_UNAVAILABLE;
...
public class LiveActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        mPlayBack = (ImageView) findViewById(R.id.player_exit);//退出播放
    ...
    private LivePlayerObserver playerObserver = new LivePlayerObserver() {
        ...
        public void onError(int code, int extra) {
            ...
            if(code == CauseCode.CODE_VIDEO_PARSER_ERROR) {
                showToast("视频解析出错");
            }else if (code==CauseCode.CODE_VIDEO_STOPPED_AS_NET_UNAVAILABLE){
                showToast("网络出现问题");
            }else if (code==CauseCode.CODE_HTTP_CONNECT_ERROR){
                showToast("直播已停止");
...
//            showToast("音频第一帧已解析");
        ...
        public void onStateChanged(StateInfo stateInfo) {
            if(stateInfo!=null &&stateInfo.getCauseCode() ==  CODE_VIDEO_STOPPED_AS_NET_UNAVAILABLE) {
                showToast("网络已断开");
            }
        }
